...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_CE_Pin|LCD_DC_Pin|CH2_TX_Pin|CH1_TX_Pin
  ...
  /*Configure GPIO pins : LCD_CE_Pin LCD_DC_Pin CH2_TX_Pin CH1_TX_Pin
                           RELAY_1__Pin RELAY_2__Pin */
  GPIO_InitStruct.Pin = LCD_CE_Pin|LCD_DC_Pin|CH2_TX_Pin|CH1_TX_Pin
                          |RELAY_1__Pin|RELAY_2__Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : CH2_RX_Pin */
  GPIO_InitStruct.Pin = CH2_RX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(CH2_RX_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : CH1_RX_Pin */
  GPIO_InitStruct.Pin = CH1_RX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(CH1_RX_GPIO_Port, &GPIO_InitStruct);
