...
int main(void)
{
  ...
  measureArraySemHandle = osSemaphoreNew(1, 1, &measureArraySem_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BUTTON_1_Pin NRF_IRQ_Pin */
  GPIO_InitStruct.Pin = BUTTON_1_Pin|NRF_IRQ_Pin;
  ...
  /*Configure GPIO pins : CH2_RX_Pin CH1_RX_Pin */
  GPIO_InitStruct.Pin = CH2_RX_Pin|CH1_RX_Pin;
