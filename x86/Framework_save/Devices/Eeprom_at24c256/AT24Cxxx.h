...
extern I2C_HandleTypeDef hi2c1; // used i2c-handle, see main.c

class AT24Cxxx {
public:
	// user configuration
	constexpr static I2C_HandleTypeDef *I2C_HANDLE = &hi2c1;
	constexpr static uint8_t DEVICE_ADDRESS = 0xA0;
